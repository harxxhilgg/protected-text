...
export const faqs: FAQsProps[] = [
  ...
  },
  {
    ...
    answer:
      "Sites aren't deleted automatically. We'll keep them until you delete them yourself.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "All that we have are encrypted versions of notes that you store on our servers, so once you delete your notes, that's it.",
  },
];
